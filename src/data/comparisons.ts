...
export const comparisons: Comparison[] = [
  ...
  },
  {
    ...
    thenDisplay: '2.72%',
    nowDisplay: '46.50%',
    thenLabel: 'GPT-4o · Nov 2024 · finalized HLE',
    nowLabel: 'Current leader · Sep 2026',
    factor: 17.1,
    factorLabel: '17.1× the score',
    evidence: 'observed',
    summary: 'On the finalized 2,500-question HLE, frontier accuracy rose from GPT-4o’s 2.72% November 2024 result to the current 46.50% leaderboard snapshot.',
    caution: 'Scale finalized HLE in April 2025 and moved the earlier version to HLE-preview. This comparison uses the finalized leaderboard series so benchmark versions are not silently mixed.',
    sources: [
...
export const hleHistory = [
  { label: 'GPT-4o', date: 'Nov 2024', score: 2.72 },
  { label: 'o1', date: 'Dec 2024', score: 7.96 },
  { label: 'Gemini 2.5 Pro Experimental', date: 'Mar 2025', score: 18.16 },
  { label: 'o3 (high)', date: 'Apr 2025', score: 20.32 },
